...
class JsonEditor:
    ...
    def __init__(self, master, file, **options):
        ...
        wrapper = ttk.Frame(master, width=400, height=240)
        ...
        self.tree.tag_configure(Tags.ROOT, background='green')
    ...
    def set_columns(self, columns=('Key', 'Value')):
        ...
        for i in range(len(columns)):
            # self.tree.column('#'+str(i), width=600)
    ...
    def verify_value(self, value):
        if value and len(value.encode('utf-8')):
            return True
        return False